  ...
  return (
    ...
    >
      ...
      <Grid container spacing={4} sx={{ justifyContent: "center", mt: 4 }}>
        {[ 
          { icon: <LocationOnIcon fontSize="large" sx={{ color: "#ffd633" }} />, title: "Our Campus", content: "123" },
          { icon: <PhoneIcon fontSize="large" sx={{ color: "#ffd633" }} />, title: "Phone", content: "+1 123-456-7890" },
          { icon: <EmailIcon fontSize="large" sx={{ color: "#ffd633" }} />, title: "Email", content: "cuisineCareers@fusion-foodies.com.com" },
        ].map((card, index) => (
          <Grid item xs={12} sm={6} md={4} key={index} data-aos="flip-up">
            ...
            >
              <CardContent>
                {card.icon}
                <Typography variant="h6" sx={{ fontWeight: "bold", color: "#ffd633" }}>
                  {card.title}
                </Typography>
      ...
      <Grid container spacing={6} sx={{ mt: 6 }}>
        ...
        <Grid item xs={12} md={6} data-aos="fade-left">
          <Box component="form" onSubmit={handleSubmit} sx={{ maxWidth: "500px", mx: "auto", p: 3, backgroundColor: "#fff", borderRadius: 3, boxShadow: "0 8px 24px rgba(0, 0, 0, 0.15)" }}>
            ...
            <Button variant="contained" type="submit" fullWidth sx={{ backgroundColor: "#ffd633", "&:hover": { backgroundColor: "#990000" } }}>Submit</Button>
          </Box>
        </Grid>
      </Grid>
    </Box>
